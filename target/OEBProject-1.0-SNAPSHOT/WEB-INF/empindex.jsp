                                    ...
                                    <div class="x_content">
                                        <form action="ManageEmpServlet" method="POST">
                                            ...
                                            <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action1">
                                                <thead>
                                                    <tr>
                                                        <th><input type="checkbox" class="flat" id="check-all-1"></th>
                                                ...
                                                <tbody>
                                                    <c:forEach items="${employees}" var="e" varStatus="vs">
                                                        <tr id="tr${e.empNo}">
                                                            <td style="text-align:center;"><input type="checkbox" name="table_records" value="${e.empNo}" class="flat"></td>
                                                            <td style="text-align:center;">${e.empName}</td>
                                                            <td style="text-align:center;">${e.constraint.employeePosition.positionName}</td>
                                                            <td style="text-align:center;">${e.constraint.employmentType.empTypeName}</td>
                                                            <td style="text-align:center;"><fmt:formatNumber value="${e.specPay!=null?e.specPay:e.constraint.pay}" pattern="#,###,###.##"/> บาท/${e.constraint.payType.payTypeName} ${e.specPay!=null?'':'(ตามตำแหน่ง)'}</td>
